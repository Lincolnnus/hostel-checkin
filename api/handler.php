...
$query = sprintf("INSERT INTO `record`(rid,confirmation,hotelName,priceName,status,createDate,codeID,title,name,firstName,address,company,zip,city,country,state,email,tel,fax,currency,totalPrice,totalRoom,visitortax,totalVisitortax,origin,amountcc,autorisationcc,transactioncc,comment,roomnamelist,rememberprice,room1,typeofbed1,numberofadults1,arrivalday1,arrivalmonth1,arrivalyear1,arrivalhour1,numberofdays1,nonsmoking1,numberofchildren1,room2,typeofbed2,numberofadults2,arrivalday2,arrivalmonth2,arrivalyear2,arrivalhour2,numberofdays2,nonsmoking2,numberofchildren2,room3,typeofbed3,numberofadults3,arrivalday3,arrivalmonth3,arrivalyear3,arrivalhour3,numberofdays3,nonsmoking3,numberofchildren3,typeresa,extrafield) VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')",
